      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Typography paragraph sx={{ mb: 4, color: 'text.secondary', fontSize: '1.1rem' }}>
              ...
              <Typography variant="h6" fontWeight={600} color="primary.main" gutterBottom sx={{ mb: 3 }}>
              ...
              <Grid container spacing={3} sx={{ mb: 4 }}>
                <Grid item xs={4}>
                  ...
                  >
                    <Smartphone sx={{ fontSize: 40, color: theme.palette.primary.main, mb: 1 }} />
                ...
                <Grid item xs={4}>
                  ...
                  >
                    <Laptop sx={{ fontSize: 40, color: theme.palette.secondary.main, mb: 1 }} />
                    <Typography variant="subtitle2" fontWeight={600}>
                      OKA Admin
                    </Typography>
                  </Card>
                ...
                <Grid item xs={4}>
                  <Card
                    sx={{
                      ...
                      '&:hover': {
                        transform: 'translateY(-4px)',
                        borderColor: theme.palette.accent?.main || '#ff6f00',
                      },
                    }}
                  >
                    <Tablet sx={{ fontSize: 40, color: theme.palette.accent?.main || '#ff6f00', mb: 1 }} />
                    <Typography variant="subtitle2" fontWeight={600}>
                      Off-Action
                    </Typography>
                  </Card>
              ...
              <Grid container spacing={2}>
                {[
                  { icon: <Security />, text: 'Secure Platform', color: 'primary.main' },
                  { icon: <TrendingUp />, text: 'Real-time Analytics', color: 'success.main' },
                  { icon: <AccountBalance />, text: 'Portfolio Management', color: 'warning.main' },
                ].map((feature, index) => (
                    ...
                    <Box sx={{ textAlign: 'center' }}>
                      <Box
                        sx={{
                          ...
                          p: 1.5,
                          borderRadius: 3,
                          background: `linear-gradient(135deg, ${theme.palette[feature.color.split('.')[0]][feature.color.split('.')[1]]} 0%, ${alpha(theme.palette[feature.color.split('.')[0]][feature.color.split('.')[1]], 0.5)} 100%)`,
                          mb: 1,
                        }}
                      >
        ...
        <Box sx={{ textAlign: 'center', mt: 4 }}>
          ...
          <Typography variant="caption" sx={{ color: 'white', opacity: 0.6 }}>
            A product of Omni Financial Advisor Platform | SEBI Registration No: INF/12345/2010
          </Typography>
        </Box>
      </Container>
    </Box>
